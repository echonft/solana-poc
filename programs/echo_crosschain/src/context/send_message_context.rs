...
pub struct SendMessageContext<'info> {
    ...
    #[account(
    mut,
    address = config.wormhole.bridge @ EchoCrosschainError::InvalidWormholeConfig
    )]
    ...
    #[account(
    mut,
    address = config.wormhole.fee_collector @ EchoCrosschainError::InvalidWormholeFeeCollector
    )]
    ...
    #[account(
    mut,
    address = config.wormhole.sequence @ EchoCrosschainError::InvalidWormholeSequence
    )]
